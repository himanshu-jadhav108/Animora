...
- **Source Code (MIT License)**: The underlying source code is licensed under the permissive MIT License. You are completely free to inspect, copy, modify, merge, publish, distribute, sublicense, and sell copies of the software according to its terms.
...
- **Registration Statement**: This repository does not claim that "Animora" is a registered trademark unless formal registration is officially completed and documented.
